...
header('Content-Disposition: attachment;filename="SGC_ReportePostulantes_'.date("Y_m_d_His").'.xlsx"');
...
header('Content-Type: application/vnd.ms-excel');
            header('Content-Disposition: attachment;filename="SGC_ReportePostulantes_'.date("Y-m-d_H-i-s").'.xls"'); // file name of excel
            header('Cache-Control: max-age=0');
